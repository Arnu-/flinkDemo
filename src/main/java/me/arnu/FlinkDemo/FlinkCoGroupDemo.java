...
//    private final static Logger logger = LoggerFactory.getLogger("FlinkCoGroupDemo");
//
...
//        }).name("取出结构中的数据");
//
//        navCardStream.coGroup(pageCardStream)
...
//                .apply(new CoGroupFunction<Tuple2<String, JSONObject>, Tuple2<String, JSONObject>, String>() {
//                    @Override
//                    public void coGroup(Iterable<Tuple2<String, JSONObject>> navJsons, Iterable<Tuple2<String, JSONObject>> pageJsons, Collector<String> collector) throws Exception {
//
